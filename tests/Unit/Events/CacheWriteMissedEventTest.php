...
class CacheWriteMissedEventTest extends TestCase
{
    /**
     * @var CacheWriteMissedEvent
     */
    protected CacheWriteMissedEvent $event;
    ...
    {
        $this->event = new CacheWriteMissedEvent($this->storeName, $this->key, $this->value, $this->ttl);
    }
